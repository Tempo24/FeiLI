...
@interface ThirdAAViewController ()<UICollectionViewDelegateFlowLayout,UICollectionViewDataSource>{
...
NSString *const thirdCellID = @"detailCell";
@implementation ThirdAAViewController
...
- (void)viewDidLoad {
    ...
    label2.text = _nameLabel2;
    [labelView addSubview:label2];
    
    UILabel *label3 = [[UILabel alloc]initWithFrame:CGRectMake(95, 5, 40, 20)];
    ...
    [_collectionView registerNib:nib forCellWithReuseIdentifier:thirdCellID];
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath{
    ...
    SecondBBCollectionViewCell *cell = [collectionView dequeueReusableCellWithReuseIdentifier:thirdCellID forIndexPath:indexPath];
    if (titleArr.count != 0) {
